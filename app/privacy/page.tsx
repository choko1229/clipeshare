...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <LegalArticle index="6" title="第三者提供">
        <p>運営者は、以下のいずれかに該当する場合を除き、取得した個人情報を本人の同意なく第三者に提供しません。</p>
        <ul>
      ...
      <LegalArticle index="9" title="開示・訂正・利用停止等の請求">
        <p>
